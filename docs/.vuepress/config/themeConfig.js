...
module.exports = {
  ...
  repo: 'yuhaohaozzz/yuhaohaozzz.github.io', // 导航栏右侧生成Github链接
  ...
  author: {
    ...
    name: '喻好好', // 必需
    link: 'https://github.com/yuhaohao', // 可选的
  },
  blogger: {
    // 博主信息，显示在首页侧边栏
    // avatar: '/img/dengxia.gif',
    avatar: '/img/muyan.jpg',
    name: '喻好好',
    slogan: '得道多助,失道寡助',
  },
  social: {
    ...
    icons: [
      {
        ...
        title: 'GitHub',
        link: 'https://github.com/yuhaohao',
      },
      {
        iconClass: 'icon-youjian',
        title: '发邮件',
        link: 'mailto:shengyinyu@163.com',
      },
      {
        iconClass: 'icon-rss',
        title: '订阅',
